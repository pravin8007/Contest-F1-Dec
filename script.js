let data = [
  ...
  function concatenateArray() {
    let dummyArray = [
        { name: "dummy1", age: 23, profession: "designer" },
        { name: "dummy2", age: 30, profession: "developer" },
    ];
    data = data.concat(dummyArray);
    console.log("Concatenated Array:", data);
  }
  ...
  function checkAgeAbove25() {
    let isAbove25 = data.some(function(person) {
        return person.age > 25 ;
      });
    console.log("Is there at least one person above the age of 25 ? ", isAbove25);
  }
  ...
  function updateJohnsProfession() {
    ...
    if (john) {
        ...
        console.log("John's profession updated to :" ,john.profession);
    }
  }
